...
enum class PrefName(val data: Pref) {  //TODO: Split this into multiple files
    ...
    PrimaryColor(Pref(Location.Player, Int::class, Color.parseColor("#FFFFFFFF"))),
    SecondaryColor(Pref(Location.Player, Int::class, Color.parseColor("#FF00000"))),
    Outline(Pref(Location.Player, Int::class, 0)),
    SubBackground(Pref(Location.Player, Int::class, Color.parseColor("#00000000"))),
    SubWindow(Pref(Location.Player, Int::class, Color.parseColor("#00000000"))),
